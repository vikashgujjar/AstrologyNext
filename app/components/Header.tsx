...
const LOCATIONS_IN_MENU = locations.slice(0, 24);

const navLinks = [
  { label: "Chat now", href: "/connect-with-astro-sanatana" },
  { label: "Call now", href: "tel:+13413455238" },
...
export default function Header() {
  ...
  const [megaLocOpen, setMegaLocOpen] = useState(false);
  ...
  function openServices() { setMegaOpen(true); setMegaLocOpen(false); }
  function openLocations() { setMegaLocOpen(true); setMegaOpen(false); }
  function closeBoth() { setMegaOpen(false); setMegaLocOpen(false); }
      ...
      >
        <nav className="mx-auto flex bg-background items-center justify-between px-4 sm:px-10 md:px-14 lg:px-20 py-2 md:py-4">
          ...
          <div className="hidden lg:flex lg:gap-x-8 justify-center flex-1 items-center">
            <Link className="text-sm font-medium text-secondary hover:text-primary transition-colors" href="/connect-with-astro-sanatana">Chat now</Link>
            <Link className="text-sm font-medium text-secondary hover:text-primary transition-colors" href="tel:+13413455238">Call now</Link>

            {/* Services trigger */}
            <button
              onClick={() => megaOpen ? closeBoth() : openServices()}
            ...
            {/* Locations trigger */}
            <button
              onClick={() => megaLocOpen ? closeBoth() : openLocations()}
              onMouseEnter={openLocations}
              className={`flex items-center gap-1 text-sm font-medium transition-colors ${megaLocOpen ? "text-primary" : "text-secondary hover:text-primary"}`}
            >
              Locations
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className={`transition-transform duration-200 ${megaLocOpen ? "rotate-180" : ""}`}>
                <path d="m6 9 6 6 6-6" />
              </svg>
            </button>
          ...
          <div className="lg:gap-x-4 justify-center hidden lg:flex flex-row items-center">
            <Link href="https://wa.me/13413455238" target="_blank" rel="noopener noreferrer">
            ...
            <div className="max-w-7xl mx-auto px-6 xl:px-10 py-7 grid grid-cols-4 gap-7">
              ...
              <div className="col-span-1 flex flex-col gap-4 bg-[#FFF2EB] rounded-2xl p-5 border border-[#ffc09d]/40 justify-between">
                <div className="flex flex-col gap-3">
                  ...
                  <h3 className="font-playfair-display text-foreground font-semibold text-base leading-snug">Book a Free<br />Consultation</h3>
                ...
                <div className="flex flex-col gap-2.5">
                  <Link href="https://wa.me/13413455238" target="_blank" rel="noopener noreferrer" onClick={closeBoth} className="inline-flex items-center gap-2 bg-[#25D366] text-white font-quicksand font-semibold rounded-full px-4 py-2.5 hover:bg-[#25D366]/85 transition-colors text-xs w-full justify-center">
                  ...
                  <Link href="tel:+13413455238" onClick={closeBoth} className="inline-flex items-center gap-2 border border-secondary text-secondary font-quicksand font-semibold rounded-full px-4 py-2.5 hover:bg-secondary hover:text-white transition-colors text-xs w-full justify-center">
                  ...
                  <Link href="/connect-with-astro-sanatana" onClick={closeBoth} className="text-center text-secondary font-quicksand font-semibold text-xs hover:text-secondary/70 transition-colors mt-1">
          ...
          >
            <div className="max-w-7xl mx-auto px-6 xl:px-10 py-7 grid grid-cols-4 gap-7">
              ...
              <div className="col-span-3 flex flex-col gap-5">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-[10px] font-quicksand font-semibold uppercase tracking-widest text-primary/60 mb-0.5">We Serve</p>
                    <h3 className="font-playfair-display text-foreground text-lg font-semibold leading-tight">Our Locations</h3>
                  </div>
                  <Link
                    href="/#locations"
                    onClick={closeBoth}
                ...
                <div className="grid grid-cols-4 gap-1">
                  {LOCATIONS_IN_MENU.map((loc) => (
                    <Link
                      key={loc.slug}
                      href={`/locations/${loc.slug}`}
                      onClick={closeBoth}
                      className="flex items-center gap-2.5 px-3 py-2.5 rounded-xl hover:bg-[#FFF2EB] transition-colors group"
                    >
                      <div className="w-7 h-7 rounded-full bg-primary/10 flex items-center justify-center shrink-0">
                        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-secondary">
                          <path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z" />
                          <circle cx="12" cy="10" r="3" />
                        </svg>
                      </div>
                      <p className="text-[13px] font-quicksand font-semibold text-foreground group-hover:text-secondary transition-colors leading-snug truncate">
                        {loc.name}
                      </p>
                    </Link>
                  ))}
              ...
              <div className="col-span-1 flex flex-col gap-4 bg-[#FFF2EB] rounded-2xl p-5 border border-[#ffc09d]/40 justify-between">
                <div className="flex flex-col gap-3">
                  ...
                  <h3 className="font-playfair-display text-foreground font-semibold text-base leading-snug">Find Us<br />Near You</h3>
                  <p className="text-primary font-quicksand font-medium text-xs leading-relaxed">
                    Serving clients across the USA — in-person and online consultations available from any location.
                  </p>
                </div>
                <div className="flex flex-col gap-2.5">
                  <Link href="https://wa.me/13413455238" target="_blank" rel="noopener noreferrer" onClick={closeBoth} className="inline-flex items-center gap-2 bg-[#25D366] text-white font-quicksand font-semibold rounded-full px-4 py-2.5 hover:bg-[#25D366]/85 transition-colors text-xs w-full justify-center">
                  ...
                  <Link href="/location" onClick={closeBoth} className="text-center text-secondary font-quicksand font-semibold text-xs hover:text-secondary/70 transition-colors mt-1">
                    View all locations →
                  </Link>
                </div>
              </div>
          ...
          <div className="flex flex-col px-6 py-4">
            ...
            <div className="flex justify-between items-center mb-8">
              <Link className="-m-1.5 p-1.5 flex items-center gap-2.5" href="/" onClick={() => setMenuOpen(false)}>
                <div className="w-22 h-22 relative">
                  <Image alt="Astro Sanatana" fill decoding="async" className="object-contain" src="/logo.png" style={{ position: "absolute", height: "100%", width: "100%", inset: 0, color: "transparent" }} />
                </div>
                <div className="flex flex-col text-center leading-tight">
                  <span className="font-playfair-display uppercase font-bold text-primary text-3xl md:text-3xl tracking-wide">Astro</span>
                  <span className="font-playfair-display uppercase font-bold text-[#e10000] text-3xl md:text-3xl">Sanatana</span>
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="border-b border-[#ffc09d]/20">
                ...
                {mobileServicesOpen && (
                  <div className="flex flex-col gap-0.5 pb-3">
                    <Link href="/services" onClick={() => setMenuOpen(false)} className="flex items-center gap-3 px-2 py-2 rounded-xl hover:bg-[#FFF2EB] transition-colors">
                    ...
                    {services.map((s) => (
                      <Link key={s.slug} href={`/services/${s.slug}`} onClick={() => setMenuOpen(false)} className="flex items-center gap-3 px-2 py-2 rounded-xl hover:bg-[#FFF2EB] transition-colors">
              ...
              <div className="border-b border-[#ffc09d]/20">
                ...
                >
                  Locations
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className={`transition-transform duration-200 ${mobileLocationsOpen ? "rotate-180" : ""}`}>
                    <path d="m6 9 6 6 6-6" />
                  </svg>
                </button>
                {mobileLocationsOpen && (
                  <div className="flex flex-col gap-0.5 pb-3">
                    {LOCATIONS_IN_MENU.map((loc) => (
                      <Link key={loc.slug} href={`/locations/${loc.slug}`} onClick={() => setMenuOpen(false)} className="flex items-center gap-3 px-2 py-2 rounded-xl hover:bg-[#FFF2EB] transition-colors">
                        ...
                        <span className="text-sm font-quicksand font-medium text-primary">{loc.name}</span>
                      </Link>
                    ))}
                    <Link href="/location" onClick={() => setMenuOpen(false)} className="flex items-center gap-3 px-2 py-2 rounded-xl hover:bg-[#FFF2EB] transition-colors">
                      <div className="w-8 h-8 rounded-lg bg-secondary/10 flex items-center justify-center shrink-0">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-secondary">
                          <path d="M5 12h14" /><path d="m12 5 7 7-7 7" />
                        </svg>
                      </div>
                      <span className="text-sm font-quicksand font-semibold text-secondary">View More Locations</span>
                    </Link>
                  </div>
                )}
              </div>
              ...
              <Link className="text-lg font-medium text-secondary hover:text-primary py-3 border-b border-[#ffc09d]/20" href="/gallery" onClick={() => setMenuOpen(false)}>
                Gallery
              </Link>
              {/* Location direct link */}
              <Link className="text-lg font-medium text-secondary hover:text-primary py-3 border-b border-[#ffc09d]/20" href="/contact" onClick={() => setMenuOpen(false)}>
                Contact Us
              </Link>
            </div>
            ...
            <div className="mt-8 space-y-4 font-quicksand text-primary text-center">
              ...
              <div className="flex gap-3 justify-center pt-2">
                <Link href="https://wa.me/13413455238" target="_blank" rel="noopener noreferrer" onClick={() => setMenuOpen(false)} className="inline-flex items-center gap-2 bg-secondary text-white font-quicksand font-semibold rounded-full px-6 py-3 hover:bg-secondary/80 transition-colors text-sm">
                  Chat on WhatsApp
                </Link>
                <Link href="tel:+13413455238" onClick={() => setMenuOpen(false)} className="inline-flex items-center gap-2 border border-secondary text-secondary font-quicksand font-semibold rounded-full px-6 py-3 hover:bg-secondary hover:text-white transition-colors text-sm">
                  Call Now
                </Link>
              </div>
            </div>
