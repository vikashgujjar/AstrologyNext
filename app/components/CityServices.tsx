...
const cityData: { city: string; services?: string[] }[] = [
  ...
  { city: "San Diego" },
  {
    city: "California",
    services: [
      "Love Back Expert in California",
      "Black Magic Removal in California",
      "Psychic in California",
      "Psychic Mediums in California",
      "Renowned Psychic Reader in California",
      "Psychic Healing Services",
      "Psychic Readings Online",
      "Online Psychic Reading California",
      "Accurate Reading Near Me",
      "Accurate Psychic Near Me",
      "Love Psychic in California",
      "Love Tarot Readings Near Me",
      "Psychic Readings for Relationship in California",
      "Best Spiritual Guidance in California",
      "Spiritual Advisor in California",
    ],
  },
  {
    city: "Palo Alto",
    services: [
      "Astrologer in Palo Alto",
      "Psychic in Palo Alto",
      "Chakra Cleansing in Palo Alto",
      "Expert Astrologer in Palo Alto",
      "Fortune Teller in Palo Alto",
      "Get Your Ex Love Back in Palo Alto",
      "Remove Negative Energy & Black Magic in Palo Alto",
      "Love Spell in Palo Alto",
    ],
  },
  {
    city: "Bay Area",
    services: [
      "Astrologer Services in Bay Area",
      "Best Astrologer in Bay Area",
      "Psychic in Bay Area",
      "Love Back Expert in Bay Area",
      "Black Magic Removal in Bay Area",
      "Spiritual Healer in Bay Area",
    ],
  },
  {
    city: "Fremont",
    services: [
      "Astrologer in Fremont",
      "Indian Psychic in Fremont",
      "Fortune Teller in Fremont",
      "Chakra Cleansing in Fremont",
      "Negative Energy Removal in Fremont",
      "Black Magic Removal in Fremont",
      "Get Your Love Back in Fremont",
      "Indian Astrologer in Fremont",
      "Love Spell in Fremont",
    ],
  },
];
